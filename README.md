...
- **Smart File Organization**: Organize files by type, extension, date, size, alphabetical order or even custom criteria (e.g. number of files per folder, starting characters of file, tags and metadata)
